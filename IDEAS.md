...
- **Library built (Aug 2026):** `assets/tegelweg-papers/` — 114 redacted assets from all 12 unique sheets (full line/cream/tinted, 22 details, 15 hand-lettered words, 4 color objects, 8 social tiles), generated by `scripts/tegelweg_papers.py`. Rules and catalogue in the library README. The 240314 PDF is photocopy duplicates of the Neu set; excluded.
